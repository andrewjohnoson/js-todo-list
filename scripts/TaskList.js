...
export default class TaskList {
    ...
    static init() {
        this.taskListSectionElement = document.querySelector(this.selectors.taskListSectionTag);
    };
    ...
    static getTasks() {
        const tasksJSON = localStorage.getItem(this.selectors.key);
        const tasksObj = JSON.parse(tasksJSON);
        const tasksArr = tasksObj ? Object.values(tasksObj) : [];
        const tasks = [];
    ...
    static printTasks() {
        ...
        const currentDate = DateController.getDate("[data-js-dateselector-datefield]");
    ...
    static saveTasks() {
        ...
        localStorage.setItem(this.selectors.key, tasksJSON);
    };
};